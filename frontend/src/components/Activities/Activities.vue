<template>
  ...
  <FadedScrollableDiv class="flex flex-col h-full overflow-y-auto">
    ...
    <div v-else-if="title == 'Follow Up'" class="h-full flex flex-col px-3 sm:px-10">
      <FollowUpArea
        :doctype="doctype"
        :docname="docname"
      />
...
import FollowUpArea from '@/components/Activities/FollowUpArea.vue'
...
const emptyText = computed(() => {
  ...
  } else if (title.value == 'Follow Up') {
    text = 'No Follow Up Data'
  }
  return text
})
