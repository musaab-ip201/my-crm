      ...
      <div class="p-4 pt-5">
        <div class="flex justify-center">
          <div class="flex flex-col items-center">
            ...
            <h3 class="font-semibold text-xl text-ink-gray-9">IP CRM</h3>
          </div>
        </div>
        ...
        <!-- <p class="text-sm text-ink-gray-6 px-2 mt-2">
          IP SUPERSHOPPEE PRIVATE LIMITED
        </p> -->
      </div>
    </template>
  </Dialog>
...
let links = [
  ...
  },
  {
    ...
    url: 'http://crm.ipshopy.org/crm/help-center/introduction',
    icon: LucideBookOpen,
  },
  // {
