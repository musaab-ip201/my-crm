			...
			notify_user(
				{
					...
					"message": doc.get("message") or doc.get("message_content") or "",
...
def create_whatsapp_message(
	...
	if frappe.db.exists("DocType", "CRM Interakt Settings") and interakt_api.is_enabled():
		if content_type == "text":
			return interakt_api.send_text_message_to_lead(reference_doctype, reference_name, message, reply_to=reply_to)
		elif content_type in ("image", "document", "video"):
			return interakt_api.send_media_message_to_lead(
				reference_doctype, reference_name, attach, content_type,
